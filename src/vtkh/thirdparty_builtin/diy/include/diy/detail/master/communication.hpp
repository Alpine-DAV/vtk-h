namespace vtkhdiy
{
    ...
    namespace detail
    {
        ...
        {
            using VecWin = vtkhdiy::detail::VectorWindow<T>;
...
} // namespace vtkhvtkhdiy


/** InFlightRecv **/

vtkhdiy::Master::InFlightRecv&
vtkhdiy::Master::
...
vtkhdiy::Master::InFlightSendsList&
vtkhdiy::Master::inflight_sends()
{
