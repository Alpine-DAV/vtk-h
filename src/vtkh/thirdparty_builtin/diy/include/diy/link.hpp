...
namespace vtkhdiy
{
  ...
  struct AMRLink: public Link::Registrar<AMRLink>
  {
    ...
    public:
      ...
      void          save(BinaryBuffer& bb) const override
      {
          Link::save(bb);
          vtkhdiy::save(bb, dim_);
          vtkhdiy::save(bb, local_);
          vtkhdiy::save(bb, nbr_descriptions_);
          vtkhdiy::save(bb, wrap_);
      }
      ...
      void          load(BinaryBuffer& bb) override
      {
          Link::load(bb);
          vtkhdiy::load(bb, dim_);
          vtkhdiy::load(bb, local_);
          vtkhdiy::load(bb, nbr_descriptions_);
          vtkhdiy::load(bb, wrap_);
      }
  ...
  namespace detail
  {
    ...
    template<>
    struct Serialization<vtkhdiy::AMRLink::Description>
    {
        static void         save(vtkhdiy::BinaryBuffer& bb, const vtkhdiy::AMRLink::Description& x)
        {
            vtkhdiy::save(bb, x.level);
            vtkhdiy::save(bb, x.refinement);
            vtkhdiy::save(bb, x.core);
            vtkhdiy::save(bb, x.bounds);
        }

        static void         load(vtkhdiy::BinaryBuffer& bb, vtkhdiy::AMRLink::Description& x)
        {
            vtkhdiy::load(bb, x.level);
            vtkhdiy::load(bb, x.refinement);
            vtkhdiy::load(bb, x.core);
            vtkhdiy::load(bb, x.bounds);
        }
    };
}
