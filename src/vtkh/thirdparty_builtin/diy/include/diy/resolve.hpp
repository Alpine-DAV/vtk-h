...
namespace vtkhdiy
{
    ...
    inline void    fix_links(vtkhdiy::Master& master, vtkhdiy::DynamicAssigner& assigner);

    // auxiliary functions; could stick them into detail namespace, but they might be useful on their own
    inline void    record_local_gids(const vtkhdiy::Master& master, vtkhdiy::DynamicAssigner& assigner);
    inline void    update_links(vtkhdiy::Master& master, const vtkhdiy::DynamicAssigner& assigner);
}

void
vtkhdiy::
record_local_gids(const vtkhdiy::Master& master, vtkhdiy::DynamicAssigner& assigner)
{
...
void
vtkhdiy::
update_links(vtkhdiy::Master& master, const vtkhdiy::DynamicAssigner& assigner)
{
...
void
vtkhdiy::
fix_links(vtkhdiy::Master& master, vtkhdiy::DynamicAssigner& assigner)
{
